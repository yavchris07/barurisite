    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-2 col-md-6 single-footer-widget">
          <h4>Top de Produits</h4>
          <ul>
            <li><a href="#">Veste sur mesure</a></li>
            <li><a href="#">Tuniques</a></li>
            <li><a href="#">Tissus</a></li>
            <li><a href="#">Accessoirs</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-6 single-footer-widget">
          <h4>Veste</h4>
          <ul>
            <li><a href="#">Choix couleur</a></li>
            <li><a href="#">Choix modèle</a></li>
            <li><a href="#">Mesure propre</a></li>
            <li><a href="#">Autres</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-6 single-footer-widget">
          <h4>Tunique Hommes,Femmes</h4>
          <ul>
            <li><a href="#">Choix couleur</a></li>
            <li><a href="#">Choix modèle</a></li>
            <li><a href="#">Mesure propre</a></li>
