                ...
                <ul class="nav navbar-nav center_nav pull-right">
                  ...
                  <li class="nav-item submenu dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="accessoires.php">Accessoirs</a>
                      </li>
                      <!-- <li class="nav-item">
                  ...
                  <!-- <li class="nav-item submenu dropdown">
                    <a href="apropos.php" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                      aria-expanded="false">Apropos</a>
                     <ul class="dropdown-menu">
                      <li class="nav-item">
                        <a class="nav-link" href="apropos.php">Apropos</a>
                      </li>
