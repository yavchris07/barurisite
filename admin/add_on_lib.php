                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="livre_auteur">Maison d'édition</label>
                        <input type="text" name="maison_d_edition" <?php if(isset($_POST['maison_d_edition'])){ $myvalue=$_POST['maison_d_edition'];?>value="<?php echo $myvalue ;} ?>"  class="form-control" id="maison_d_edition" placeholder="maison d'édition">
                      </div>
...
echo  $mycategorie_designation['designation'];
                        ...
                        <select name="Collection" class="form-control" id="livre_categorie">                       
                            ...
                            <option value="<?php echo $edit_me['collections'] ?>" selected>  <?php echo $edit_me['collections'] ?>  </option>
                              ...
                              <option value="Locale">etrangère</option>
                          
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="categorie_descript">Sythèse du livre</label>
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select name="Collection" class="form-control" id="livre_categorie">
                          ...
                          <option value='Locale' > Locale </option>
                          <option value='entrangère' >entrangère  </option>
                         
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="categorie_descript">Synthèse du livre</label>
                        <textarea name="synthese"  type="text" style="min-height:350px;" class="form-control" id="categorie_descript" placeholder="Synthèse du livre"><?php if(isset($_POST['synthese'])){ $myvalue=$_POST['synthese']; echo $myvalue ;} ?></textarea>
                      </div>  
                     <div id="image_de_couverture" class="input-group col-xs-12 mb-3">   
